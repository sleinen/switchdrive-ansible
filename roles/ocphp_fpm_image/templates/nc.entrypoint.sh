...
cp "/etc/owncloud/php.fpm.{{owncloud_version}}.ini" "{{nc_php_conf_dir[owncloud_major_version]}}/fpm/php.ini"
cp "/etc/owncloud/php.cli.{{owncloud_version}}.ini" "{{nc_php_conf_dir[owncloud_major_version]}}/cli/php.ini"
cp "/etc/owncloud/php-fpm.{{owncloud_version}}.conf" "{{nc_php_conf_dir[owncloud_major_version]}}/fpm/php-fpm.conf"
cp "/etc/owncloud/fpm_pool_owncloud.{{owncloud_version}}.conf" "{{nc_php_conf_dir[owncloud_major_version]}}/fpm/pool.d/owncloud.conf"
